...
def init():
    ...
    Cursor.execute(f"USE {DataBaseName};")
    Cursor.execute("CREATE TABLE Prisoners (PNO int(3) PRIMARY KEY,NAME VARCHAR(25),AGE INT,GENDER CHAR(1),CRIME VARCHAR(50),SENTENCE INT,CELL_BLOCK CHAR(1),PAROLE VARCHAR(3),RELEASE_DATE DATE);")
